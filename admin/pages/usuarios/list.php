...
<div class="container py-4 py-lg-5">
    <div class="admin-page-head">
        ...
        <div class="d-flex gap-2">
            <a href="form.php" class="btn btn-primary">Añadir usuario</a>
            <a href="../dashboard/index.php" class="btn btn-outline-light">Volver al panel</a>
        </div>
    </div>
    ...
    <?php if (isset($_GET['ok'])): ?>
        <div class="admin-alert-inline success">
            ...
            <div class="admin-alert-content">
                <div class="admin-alert-title">Usuario guardado</div>
                <div class="admin-alert-message">El usuario se ha guardado correctamente.</div>
            </div>
        </div>
    <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="admin-actions d-flex gap-2 flex-wrap">
                                    <a href="form.php?id=<?= (int)$u['id'] ?>" class="btn btn-warning btn-sm">Editar</a>

                                    <?php if ((int)$u['id'] !== (int)$_SESSION['usuario_id']): ?>
                                        <form method="POST" action="delete.php" style="display: inline;" onsubmit="return confirm('¿Seguro que quieres borrar este usuario?')">
