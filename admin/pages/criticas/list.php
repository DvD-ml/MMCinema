...
<div class="container py-4 py-lg-5">
    <div class="admin-page-head">
        ...
        <div class="d-flex gap-2 flex-wrap">
            <a href="form.php?tipo=pelicula" class="btn btn-primary">Añadir crítica de película</a>
            <a href="form.php?tipo=serie" class="btn btn-warning">Añadir crítica de serie</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="admin-actions d-flex gap-2 flex-wrap">
                                <a href="form.php?id=<?= (int)$c['id'] ?>&tipo=pelicula" class="btn btn-warning btn-sm">Editar</a>
            ...
            <table class="admin-table table table-dark table-hover align-middle mb-0">
                ...
                <?php foreach ($criticasSeries as $c): ?>
                    <tr>
                        ...
                        <td>
                            <div class="admin-actions d-flex gap-2 flex-wrap">
                                <a href="form.php?id=<?= (int)$c['id'] ?>&tipo=serie" class="btn btn-warning btn-sm">Editar</a>
                                <form method="POST" action="delete.php" style="display:inline;">
                                    <?php require_once __DIR__ . "/../../../helpers/CSRF.php"; echo CSRF::campoFormulario(); ?>
                                    <input type="hidden" name="id" value="<?= (int)$c['id'] ?>">
