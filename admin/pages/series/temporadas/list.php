...
<div class="container py-4 py-lg-5">
    <div class="admin-page-head">
        ...
        <a href="form.php<?= $idSerieFiltro > 0 ? '?id_serie=' . $idSerieFiltro : '' ?>" class="btn btn-primary">+ Añadir temporada</a>
    </div>
                ...
                <tbody>
                    <?php foreach ($temporadas as $temporada): ?>
                        <tr>
                            ...
                            <td>
                                <div class="acciones">
                                    <a href="form.php?id=<?= (int)$temporada['id'] ?>" class="btn btn-sm btn-primary">Editar</a>
                                    <a href="../episodios/list.php?id_temporada=<?= (int)$temporada['id'] ?>" class="btn btn-sm btn-outline-light">Episodios</a>
                                    <form method="POST" action="delete.php" style="display: inline;" onsubmit="return confirm('¿Seguro que quieres borrar esta temporada?');">
